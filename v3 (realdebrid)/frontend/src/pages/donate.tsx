    ...
    return (
      <ThemeProvider theme={NewthemeDark}>
        <CssBaseline />
          ...
          <Divider />
          <p>This project is run off of <a href="https://real-debrid.com/?id=8151698" title="Real Debrid" style={{color: "white"}}>RealDebrid </a>. If you would like to support LeechersParadise, you may also sign up for the service that LeechersParadise relies on.</p>
          <p>LeechersParadise will get commission when you sign up using our link. </p>
          <a href="https://real-debrid.com/?id=8151698" title="Real-Debrid">
            <img src="https://real-debrid.com/static/images/banner/en.png" style={{borderRadius: "8px"}}/>
          </a>
          </div>
          <Divider />
