  ...
  return (
    <React.Fragment>
      ...
      <Container disableGutters maxWidth="sm" component="main" sx={{ pt: 8, pb: 6, pl: "5px", pr: '5px'}}>
        ...
        If you would like to purchase premium using a different payment method such as crypto or paypal, please make a ticket in our <a href="https://discord.gg/47SnjxgBFb" style={{ textDecoration: 'underline', color: "#5865F2"}}>Discord</a> to begin the process.
        </Typography>
      </Container>
      {/* End hero unit */}
