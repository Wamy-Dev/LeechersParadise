      ...
      <ThemeProvider theme={NewthemeDark}>
        <Container component="main">
          ...
          <Box display="flex" justifyContent="center" alignItems="center" sx={{ mt: 2, width: "100%"}}>
            ...
            <br/><br/>Please check the email you used to purchase for your credentials. <br/> If there is something wrong with your purchase please email: contact@leechersparadise.com for help, or message a dev at our Discord: <a href="https://discord.gg/47SnjxgBFb" style={{ textDecoration: 'underline', color: "#5865F2"}}> Here</a>.
